...
namespace map
{
    ...
    const ChukVector& World::getChunks() const
    {
        return m_chunks;
    }

    const Chunk& World::getChunk(glm::ivec2 chukPos)
    {
        return m_chunks.at(chukPos.y * CHUNK_SIZE + chukPos.x);
    }
